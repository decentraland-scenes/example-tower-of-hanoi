import { Entity, Material, MaterialTransparencyMode, MeshRenderer, PBMaterial_PbrMaterial, Transform, TransformTypeWithOptionals,  VisibilityComponent, engine, } from "@dcl/sdk/ecs";
import { Color4, Quaternion, Vector3 } from "@dcl/sdk/math";
import { IconData,  uiAtlas }from "../minigame-ui/resources"
...
export class MenuLabel {    
    ...
    constructor(transform:TransformTypeWithOptionals, icon:IconData,){
        ...
        Transform.createOrReplace(this.icon, {
            ...
            scale:  (icon.blockWidth !=1 )?Vector3.create(0.35, 0.35/icon.blockWidth, 0.12):Vector3.create(0.15, 0.15, 0.15),
            parent: this.root
        })
    ...
    changeIcon(iconData:IconData){
        ...
        Transform.createOrReplace(this.icon, {
            ...
            scale:  (iconData.blockWidth !=1 )?Vector3.create(0.35, 0.35/iconData.blockWidth, 0.12):Vector3.create(0.15, 0.15, 0.15),
            parent: this.root
        })
    } 
