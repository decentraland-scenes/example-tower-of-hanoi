...
export class MenuButton {
    ...
    constructor(transform:TransformTypeWithOptionals,  buttonShapeData:ButtonShapeData, icon:IconData, _hoverText:string, callback : () => void , enabledByDefault?:boolean){
        ...
        engine.addSystem(() => {
            if (inputSystem.isTriggered(InputAction.IA_POINTER, PointerEventType.PET_DOWN, this.button)){
                ...
                if(this.enabled){
                    ...
                    callback()
                    this.playSound("sounds/button_click.mp3")          
